...
class GoodReadsReviewsScrapper:
    ...
    def scrape_user_reviews(user_id, user_name):
        try:
            ...
            try:
                ...
                print(f"Error locating or clicking 'settings' button: {e}'")
            ...
            try:
                ...
                print(f"Error locating or clicking 'review' button: {e}")
    ...
    def join_files(num_user, user_id, user_name):
        ...
        try:
            ...
            pass
        GoodReadsReviewsScrapper.delete_file(file_path_star)
